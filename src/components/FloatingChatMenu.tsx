  ...
  return (
    <div ref={menuRef} className="fixed bottom-6 right-6 z-[99998] flex flex-col items-end gap-3">
      ...
      >
        ...
        >
          <span className="px-3 py-1.5 rounded-lg bg-surface-darker/80 backdrop-blur-md border border-border-dark text-[#ffffff] text-sm font-medium">
            WhatsApp
          </span>
          <div className="w-12 h-12 rounded-full bg-[#25D366] text-[#ffffff] flex items-center justify-center shadow-lg hover:scale-110 transition-transform flex-shrink-0">
        ...
        >
          ...
          <div className="w-12 h-12 rounded-full bg-blue-500 text-[#ffffff] flex items-center justify-center shadow-lg hover:scale-110 transition-transform flex-shrink-0">
      ...
      <div className="relative flex justify-end">
        ...
        <div 
          className={`absolute bottom-full right-0 mb-3 px-4 py-2 rounded-xl bg-surface-darker/90 backdrop-blur-md shadow-xl border border-border-dark text-[#ffffff] text-xs font-bold whitespace-nowrap transition-all duration-300 origin-bottom-right ${
