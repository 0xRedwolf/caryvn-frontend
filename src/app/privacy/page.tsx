      ...
      <main className="container mx-auto px-4 lg:px-8 py-24 lg:py-32">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-slate-600 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-black text-slate-900 mb-6">3. How We Use Your Data</h2>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-black text-slate-900 mb-6">4. Cookies</h2>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-black text-slate-900 mb-6">6. Changes to This Policy</h2>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-3xl p-8 mt-16 text-center">
              <p className="text-slate-900 font-bold">Questions about our privacy practices?</p>
              <p className="text-sm text-slate-600 mt-1">Contact our support team at support@caryvn.com</p>
            </div>
          </div>
        </div>
      </main>
