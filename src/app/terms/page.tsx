      ...
      <main className="container mx-auto px-4 lg:px-8 py-24 lg:py-32">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-slate-600 leading-relaxed">
            <p className="mb-8 text-slate-500">Last updated: March 10, 2026</p>
            
            <section className="mb-12">
              <h2 className="text-3xl font-black text-slate-900 mb-6">1. Agreement to Terms</h2>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-black text-slate-900 mb-6">2. Services</h2>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-black text-slate-900 mb-6">3. Account Responsibility</h2>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-black text-slate-900 mb-6">4. Delivery Policy</h2>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-black text-slate-900 mb-6">5. Refund Policy</h2>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-black text-slate-900 mb-6">6. Prohibited Activities</h2>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-3xl p-8 mt-16 text-center">
              <p className="text-slate-900 font-bold">Have questions regarding our terms?</p>
              <p className="text-sm text-slate-600 mt-1">Contact our legal team at legal@caryvn.com</p>
            </div>
          </div>
        </div>
      </main>
